namespace OrderProduct
{
    public partial class Form1 : Form
    {
        ...
        {
            double price = 0;
            if (comboBox1.SelectedIndex == 0) price = 1.20;
            if (comboBox1.SelectedIndex == 1) price = 2.50;
            if (comboBox1.SelectedIndex == 2) price = 3.00;
            if (comboBox1.SelectedIndex == 3) price = 1.80;
